                ...
                if (selected_pair in minor_yens):
                    ...
                    if (Variances == "> 805"):
                        ...
                        if (risk_multiplier == "2_BNR_TPF" and selected_pair in majors_dollar):
                            entry_title = "Entry Guide (SL__Entry Length): More than 5 Pips Count as Position 50"
                        ...
                        if (risk_multiplier == "2_BNR_TPF" and selected_pair in majors_dollar):
                            entry_title = "Entry Guide (SL__Entry Length): More than 5 Pips Count as Position 559 - 66"
                    ...
                    if (selected_pair == "XAUUSD"):
                        ...
                        if (Variances == "> 805"):
                            ...
                            if (risk_multiplier == "2_BNR_TPF"):
                                entry_title = "Entry Guide (SL__Entry Length): More than 2 $ Count as Position 50"
                            ...
                            if (risk_multiplier == "2_BNR_TPF"):
                                entry_title = "Entry Guide (SL__Entry Length): More than 2 $ Count as Position 559 - 66"
