    ...
    if st.session_state.uploaded_data is not None:
        ...
        incompatible_map_17 = {
            '1_BNR': ["Weekly TPF Left Leg", "Previous Trend Top/Bottom",
                      ...
                      "Variant 2 Daily TPF", "8H/4H TPF Left Leg", "Variant Fakeout Any TF TPF","8H/4H_OB X TPF","4H BE Scale-in"],
            '1_BNR_TPF': ["8H/4H_OB", "8H/4H_TPF", "8H/4H_OB X TPF","4H BE Scale-in",
                ...
                def get_potential_target(trend, pair, wave, strategy,context):
                    ...
                    if (selected_pair in europe_major or selected_pair == "XAUUSD" or selected_pair in trade_curr or selected_pair == "USDJPY"):
                        if(context == "Trend 0" or context == "Range"):
                            ...
                            if(wave == "Cross Trend >=6%" or wave == "Cross Trend 4% - 5.99%" or wave == "Cross Trend <=3.99%"):
                                if(trend == "3%-4.99%"):
                                    open_target = 5.41
                                elif(trend == "5%-6.99%"):
                                    open_target = 5.41
                                    ...
                                    open_target = 5.41
                            elif(wave == "Wave 1" or wave == "Wave 2+"):
                                if(trend == "3%-4.99%"):
                                    open_target = "Top of trend to 8.99%"
                                elif(trend == "5%-6.99%"):
                                    open_target = "Top of trend to 8.99%"
