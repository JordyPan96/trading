...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        incompatible_map_17 = {
            '1_BNR': ["Weekly TPF Left Leg",
                      "2 Daily TPF Left Leg", "Daily TPF Left Leg",
                      "8H/4H TPF", "Variant 2 Daily TPF","8H/4H OB", "8H/4H TPF",  "8H/4H OB + TPF","8H/4H TPF Left Leg","Variant Fakeout 2 Daily TPF"],
        ...
        incompatible_map_29 = {
            "Wave 2+1": ['2_BNR_TPF'],
            "Cross Wave1": ['2_BNR_TPF'],
            "Cross Wave 3.5 - 4.991": ['2_BNR_TPF']
        }
    ...
    st.table(table_data)
    st.header('Variant Rules (Only for Weekly TPF Left Leg)')
    st.subheader(
    ...
    table_data5 = {
        '': ['1_BNR','1_BNR','1_BNR','1_BNR_TPF','1_BNR_TPF','2_BNR','2_BNR','2_BNR_TPF','2_BNR_TPF'],
        'Result': ["Win", 'Loss','BE', 'Win', 'Loss',"Win", 'Loss',"Win", 'Loss'],
        'Retake Rule': ["-> 2_BNR", "-> 2_BNR", '-> 2_BNR_TPF', "NO RETAKE","NO RETAKE", "NO RETAKE","-> 2_BNR_TPF", "NO RETAKE","NO RETAKE"]
    }
