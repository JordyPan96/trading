...
def calculate_strategy_grade_static(strategy_name):
    ...
    strategy_grades = {
        ...
        "2_BNR_TPF": ("A", 1.1),  # Fake out or wick/ob
...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with col1:
            ...
            POI = st.selectbox(
                "POI Type (If wave >4%, AUDCAD >3% use 2 Daily Fib, 1_BNR adjust based on mid Weekly K, 1_BNR_TPF adjust based on TPF position)",
