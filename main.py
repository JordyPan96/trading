        ...
        with col2:
            ...
            if (risk_multiplier == "1_BNR"):
                ...
                if (selected_pair in minor_yens):
                    ...
                    if (Variances == "> 805"):
                        ...
                        if (risk_multiplier == "2_BNR_TPF" and selected_pair in majors_dollar):
                            entry_title = "Entry Guide (SL__Entry Length): More than 5 Pips before 702 Count as Position 559 - 66"
            ...
            with col2:
                ...
                if (get_global('entry_model') != None):
                    ...
                    container.metric("--Note that all SL must not exceed 33%", "Minimum Length for "+selected_pair+" is "+base_percent+"%")
