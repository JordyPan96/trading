...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with st.expander(" Add New Record", expanded=False):
            ...
            with col4:
                ...
                leg_length_options = [">=90%", ">=115%", ">=140%", ">=170%", ">=2%", "NA"]
    ...
    if st.session_state.uploaded_data is not None:
        ...
        leg_length = [">=2%", ">=170%", ">=140%", ">=115%", ">=90%", "NA"]
        ...
        incompatible_map_21 = {
            "Variant 2 Daily TPF": [">=90%", ">=115%", ">=140%", ">=170%"],
            "Variant Fakeout Any TF TPF": [">=90%", ">=115%", ">=140%", ">=170%"],
            "Weekly TPF Left Leg": [">=2%"],
            "Previous Trend Top/Bottom": [">=2%"],
            "2 Daily TPF Left Leg": [">=2%"],
            "Daily TPF Left Leg": [">=2%"],
            "4H BE Scale-in":[">=90%", ">=115%", ">=140%", ">=170%",">=2%"]

        }

        incompatible_map_22 = {
            "1_BNR": [">=90%", ">=115%", ">=140%", ">=170%", ">=2%"],
            "1_BNR_TPF": [">=90%", ">=115%", ">=140%", ">=170%", ">=2%"],
            "2_BNR": ["NA"],
            "2_BNR_TPF": ["NA"],
            "3_BNR_TPF": ["NA"],
        ...
        incompatible_map_23 = {
            "XAUUSD2_BNR50": [">=115%", ">=140%", ">=2%", "NA"],
            "XAUUSD2_BNR559 - 66": [">=90%", ">=140%", ">=2%", "NA"],
            "XAUUSD2_BNR66 - 91": [">=90%", ">=140%", ">=170%", ">=2%"],
            "XAUUSD2_BNR786 - 91": [">=90%", ">=140%", ">=170%", ">=2%"],

            "XAUUSD2_BNR_TPF50": [">=115%", ">=140%", "NA"],
            "XAUUSD2_BNR_TPF559 - 66": [">=90%", ">=140%", "NA"],
            "XAUUSD2_BNR_TPF66 - 91": [">=90%", ">=140%", ">=170%"],
            "XAUUSD2_BNR_TPF786 - 91": [">=90%", ">=140%", ">=170%"],

            "XAUUSD3_BNR_TPF50": [">=115%", ">=140%", "NA"],
            "XAUUSD3_BNR_TPF559 - 66": [">=90%", ">=140%", "NA"],
            "XAUUSD3_BNR_TPF66 - 91": [">=90%", ">=140%", ">=170%"],
            "XAUUSD3_BNR_TPF786 - 91": [">=90%", ">=140%", ">=170%"],

            "AUDUSD2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "AUDUSD2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "AUDUSD3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "USDCAD2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "USDCAD2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "USDCAD3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "GBPAUD2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "GBPAUD2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "GBPAUD3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "EURAUD2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "EURAUD2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "EURAUD3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "USDJPY2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "USDJPY2_BNR_TPF50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "USDJPY2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "USDJPY2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "USDJPY3_BNR_TPF50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "USDJPY3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "USDJPY3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "USDJPY3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "GBPJPY2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "GBPJPY2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "GBPJPY3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "AUDJPY2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "AUDJPY2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "AUDJPY3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "EURJPY2_BNR50": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR559 - 66": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%", "NA"],

            "EURJPY2_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "EURJPY3_BNR_TPF50": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF559 - 66": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%", "NA"],

            "GBPUSD2_BNR50": [">=115%", ">=170%", ">=2%"],
            "GBPUSD2_BNR559 - 66": [">=115%", ">=170%", ">=2%"],
            "GBPUSD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%"],
            "GBPUSD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%"],

            "GBPUSD2_BNR_TPF50": [">=115%", ">=170%"],
            "GBPUSD2_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "GBPUSD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%"],
            "GBPUSD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%"],

            "GBPUSD3_BNR_TPF50": [">=115%", ">=170%"],
            "GBPUSD3_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "GBPUSD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%"],
            "GBPUSD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%"],

            "EURUSD2_BNR50": [">=115%", ">=170%", ">=2%"],
            "EURUSD2_BNR559 - 66": [">=115%", ">=170%", ">=2%"],
            "EURUSD2_BNR66 - 91": [">=115%", ">=140%", ">=170%", ">=2%"],
            "EU6rUSD2_BNR786 - 91": [">=115%", ">=140%", ">=170%", ">=2%"],

            "EURUSD2_BNR_TPF50": [">=115%", ">=170%"],
            "EURUSD2_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "EURUSD2_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%"],
            "EU6rUSD2_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%"],

            "EURUSD3_BNR_TPF50": [">=115%", ">=170%"],
            "EURUSD3_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "EURUSD3_BNR_TPF66 - 91": [">=115%", ">=140%", ">=170%"],
            "EU6rUSD3_BNR_TPF786 - 91": [">=115%", ">=140%", ">=170%"],
