...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with st.expander(" Add New Record", expanded=False):
            ...
            with col4:
                ...
                pattern_options = ["8H/4H_OB/SR","8H/4H_OB to OB", "8H/4H_OB to TPF","8H/4H_TPF to OB", "8H/4H TPF Left Leg",
    ...
    if st.session_state.uploaded_data is not None:
        ...
        shapes = ["8H/4H_OB/SR","8H/4H_OB to TPF","8H/4H_OB to OB","8H/4H_TPF to OB", "8H/4H TPF Left Leg",
                  "Weekly TPF Left Leg",
        ...
        incompatible_map_9 = {
            ...
            ">=13% (5% PullBack)Cross Wave 3.5 - 4.99": ['1_BNR', '1_BNR_TPF', '2_BNR'],
            # Add more restrictions as needed
        }
        ...
        incompatible_map_17 = {
            '1_BNR': ["Weekly TPF Left Leg",
                      "2 Daily TPF Left Leg", "Daily TPF Left Leg",
                      "8H/4H_TPF to OB", "Variant 2 Daily TPF","8H/4H_OB to OB", "8H/4H_TPF to OB",  "8H/4H_OB to TPF","8H/4H TPF Left Leg","Variant Fakeout 2 Daily TPF"],
            '1_BNR_TPF': ["8H/4H_OB to OB", "8H/4H_TPF to OB",  "8H/4H_OB to TPF",
            ...
            '2_BNR_TPF': ["8H/4H_OB to OB",  "8H/4H_OB to TPF",
                          "8H/4H_TPF to OB","8H/4H_OB/SR","Weekly TPF Left Leg","2 Daily TPF Left Leg", "Daily TPF Left Leg"]
        }
        ...
        incompatible_map_19 = {
            "12_BNR_TPF": ["Weekly OB", "2 Daily OB", "Daily OB",  "Weekly TPF Left Leg",
                           "2 Daily TPF Left Leg", "Daily TPF Left Leg",
                           "8H/4H_TPF to OB",  "8H/4H TPF Left Leg"],
            "22_BNR_TPF": ["Weekly OB", "2 Daily OB", "Daily OB",
                           "Variant 2 Daily TPF","Variant Fakeout 2 Daily TPF","8H/4H_TPF to OB"]
        }
        ...
        with col1:
            ...
            POI = st.selectbox(
                "POI Type (2_Daily is 2nd to Last on Weekly)",
        ...
        with col2:
            ...
            if (trend_position == "3%-4.99%"):
                if(cross_fib == "Wave 1" or cross_fib == "Wave 2+"):
                    ...
                    if(strategy == "2_BNR"):
                        if(wave == "Wave 1" or wave == "Cross Wave 3.5 - 4.99"):
                            if(pair in europe_major or pair in gold_comm):
                                ...
                                if (trend == "3%-4.99%"):
                                    base_target = 10 + base_target
                                elif (trend == "5%-6.99%"):
                                    base_target = 8 + base_target
                                elif (trend == "7%-8.99%"):
                                    base_target = 6 + base_target
                                elif (trend == "9%-10.99%"):
                                    base_target = 4 + base_target
                                elif (trend == "11%-12.99% (3.5% PullBack)"):
                                    base_target = 2 + base_target
                                elif (trend == ">=13% (5% PullBack)"):
                                    base_target = 0 + base_target
                        elif(wave == "Wave 2+"):
                            if (pair in europe_major or pair in gold_comm):
                        ...
                        if (wave == "Wave 1" and Zone_Position in ["0","+1","+2"]):
                            if (pair in europe_major or pair in gold_comm):
                                if (trend == "3%-4.99%"):
                                ...
                                if (trend == "3%-4.99%"):
                                    ...
                                    base_target = 1 + base_target
                                elif (trend == "11%-12.99% (3.5% PullBack)"):
                                    base_target = 0 + base_target
                                elif (trend == ">=13% (5% PullBack)"):
                                    base_target = 0 + base_target
                        elif (wave == "Wave 2+" and Zone_Position in ["0","+1","+2"]):
                            if (pair in europe_major or pair in gold_comm):
                                if (trend == "3%-4.99%"):
                                    base_target = 11 + base_target
                                elif (trend == "5%-6.99%"):
                                ...
                                if (trend == "3%-4.99%"):
                                    ...
                                    base_target = 0 + base_target
                        elif (wave == "Cross Wave" and Zone_Position in ["0","+1","+2"]):
                            if (pair in europe_major or pair in gold_comm):
                                base_target = 5.41
                            elif (pair in trade_curr or pair == "USDJPY"):
                                base_target = 5.41
                ...
                if (get_global('entry_model') != None):
                    container.markdown(f"""
                            <div style="color:deepskyblue; font-weight:600;">
                                ...
                                --7. Note Trigger box can only stay within 2 zones for BNR and 1 zone for TPF<br>
                                --8. Calculate STOP loss base on box, min and max value, average it and place between<br>
                                --9. Enter on first trigger box entry where SL covers the trigger box AND entry zone<br>
                                --10. If there are two entry zones now narrow it down to one<br>
                            </div>
                            """, unsafe_allow_html=True)
