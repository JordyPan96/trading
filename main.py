...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with col1:
            ...
            entry_price = st.number_input("Entry Price", min_value=1.00, value=None, step=0.001)
            stop_pips = st.number_input("Stop Loss (pips)", min_value=1.0, value=None, step=0.01)
