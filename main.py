...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with st.expander(" Add New Record", expanded=False):
            ...
            with col4:
                ...
                pattern_options = ["Wick Mid OMSS", "Wick/Zone Mid OB", "On Left TPF + Wick", " Wick Right Impulse Candle",
            ...
            with col5:
                ...
                Zone_Position_options = ["NA", "1-2", "3-6"]
    ...
    if st.session_state.uploaded_data is not None:
        ...
        def check_cooldown_period(selected_pair, uploaded_data, cooldown_days=1):
            ...
            symbol_groups = {
                ...
                'XXXUSD': {'symbols': ['USDCAD', 'AUDUSD', 'EURUSD', 'GBPUSD'], 'target': 0},
        ...
        shapes = ["On Left TPF + Wick", "Wick/Zone Mid OB", " Wick Right Impulse Candle",
        ...
        potential_rr = ["3.43-6.41", "5.41-7.41", "8.41-10.41", ">=11.41"]
        ...
        incompatible_map_17 = {
            ...
            '1_BNR_TPF': ["Wick/Zone Mid OB", "On Left TPF + Wick", " Wick Right Impulse Candle",
            ...
            '2_BNR_TPF': ["Wick/Zone Mid OB", "On Left TPF + Wick", " Wick Right Impulse Candle",
                         ],
            '3_BNR_TPF': ["Wick/Zone Mid OB", "On Left TPF + Wick", " Wick Right Impulse Candle",
        ...
        incompatible_map_21 = {
            ...
            "4H BE Scale-in":[">=90%", ">=115%", ">=135%", ">=170%",">=2%"]

        }

        incompatible_map_22 = {
            "1_BNR": [">=90%", ">=115%", ">=135%", ">=170%", ">=2%"],
            "1_BNR_TPF": [">=90%", ">=115%", ">=135%", ">=170%", ">=2%"],
            "2_BNR": ["NA"],
            "2_BNR_TPF": ["NA"],
            "3_BNR_TPF": ["NA"],
        ...
        incompatible_map_30 = {
            "3%-4.99%": ["Variant Fakeout Daily TPF","Variant Fakeout Trigger TPF"],
            "5%-6.99%": ["Variant Fakeout Daily TPF","Variant Fakeout Trigger TPF"],
            "7%-8.99%": ["Variant Fakeout Daily TPF","Variant Fakeout Trigger TPF"],
            "9%-10.99%": ["Variant Fakeout Daily TPF","Variant Fakeout Trigger TPF"],
            "11%-12.99% (4% PB)": ["Variant Fakeout Daily TPF","Variant Fakeout Trigger TPF"],
            ">=13% (5% PB, ACAD 4%)" :[]
        }
        ...
        incompatible_map_37 = {
            "Range": [">=13% (5% PB, ACAD 4%)","11%-12.99% (4% PB)"],
            "Trend 0" : ["0%-2.99%"],

        }

        incompatible_map_38 = {
            "4H BE Scale-in":["0", "1-2","3-6","5-6"],
        }
        ...
        incompatible_map_23 = {
            ...
            "XAUUSD2_BNR559 - 66": [">=90%", ">=135%", ">=2%", "NA"],
            "XAUUSD2_BNR66 - 91": [">=90%", ">=135%", ">=170%", ">=2%"],
            "XAUUSD2_BNR786 - 91": [">=90%", ">=135%", ">=170%", ">=2%"],

            "XAUUSD2_BNR_TPF50": [">=115%", ">=135%", "NA"],
            "XAUUSD2_BNR_TPF559 - 66": [">=90%", ">=135%", "NA"],
            "XAUUSD2_BNR_TPF66 - 91": [">=90%", ">=135%", ">=170%"],
            "XAUUSD2_BNR_TPF786 - 91": [">=90%", ">=135%", ">=170%"],

            "XAUUSD3_BNR_TPF50": [">=115%", ">=135%", "NA"],
            "XAUUSD3_BNR_TPF559 - 66": [">=90%", ">=135%", "NA"],
            "XAUUSD3_BNR_TPF66 - 91": [">=90%", ">=135%", ">=170%"],
            "XAUUSD3_BNR_TPF786 - 91": [">=90%", ">=135%", ">=170%"],

            "AUDUSD2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDUSD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "AUDUSD2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "AUDUSD3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDUSD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "USDCAD2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDCAD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "USDCAD2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "USDCAD3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "USDCAD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "GBPAUD2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPAUD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "GBPAUD2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "GBPAUD3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPAUD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "EURAUD2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURAUD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "EURAUD2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "EURAUD3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "EURAUD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "USDJPY2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "USDJPY2_BNR_TPF50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDJPY2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "USDJPY2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "USDJPY2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "USDJPY3_BNR_TPF50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "USDJPY3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "USDJPY3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "USDJPY3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "GBPJPY2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "GBPJPY2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "GBPJPY2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "GBPJPY3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "GBPJPY3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "AUDJPY2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "AUDJPY2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "AUDJPY2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "AUDJPY3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "AUDJPY3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "EURJPY2_BNR50": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR559 - 66": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],
            "EURJPY2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%", "NA"],

            "EURJPY2_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "EURJPY3_BNR_TPF50": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF559 - 66": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%", "NA"],
            "EURJPY3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%", "NA"],

            "GBPUSD2_BNR50": [">=115%", ">=170%", ">=2%"],
            "GBPUSD2_BNR559 - 66": [">=115%", ">=170%", ">=2%"],
            "GBPUSD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%"],
            "GBPUSD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%"],

            "GBPUSD2_BNR_TPF50": [">=115%", ">=170%"],
            "GBPUSD2_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "GBPUSD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%"],
            "GBPUSD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%"],

            "GBPUSD3_BNR_TPF50": [">=115%", ">=170%"],
            "GBPUSD3_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "GBPUSD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%"],
            "GBPUSD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%"],

            "EURUSD2_BNR50": [">=115%", ">=170%", ">=2%"],
            "EURUSD2_BNR559 - 66": [">=115%", ">=170%", ">=2%"],
            "EURUSD2_BNR66 - 91": [">=115%", ">=135%", ">=170%", ">=2%"],
            "EU6rUSD2_BNR786 - 91": [">=115%", ">=135%", ">=170%", ">=2%"],

            "EURUSD2_BNR_TPF50": [">=115%", ">=170%"],
            "EURUSD2_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "EURUSD2_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%"],
            "EU6rUSD2_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%"],

            "EURUSD3_BNR_TPF50": [">=115%", ">=170%"],
            "EURUSD3_BNR_TPF559 - 66": [">=115%", ">=170%"],
            "EURUSD3_BNR_TPF66 - 91": [">=115%", ">=135%", ">=170%"],
            "EU6rUSD3_BNR_TPF786 - 91": [">=115%", ">=135%", ">=170%"],
        ...
        def get_min_max_pips(entry_price, pair,risk_multiplier,zone_position):
            ...
            if(risk_multiplier == "2_BNR_TPF"):
                if(pair == "XAUUSD"):
                    ...
                    min_max_diff = round((max_pips_final - min_pips_final)/2,1)
                    if(min_max_diff > 10.0):
                        min_max_diff = 10.0
                    min_pips_final = round(min_pips_final + min_max_diff,1)
                    max_pips_final = round (max_pips_final + min_max_diff,1)
        ...
        with col1:
            ...
            trend_position = st.selectbox("Trend Position", available_trend_position3)
        ...
        with col2:
            ...
            if (trend_position == "3%-4.99%"):
                if(trend_context == "Range"):
                    trend_position_multiplier = 1.0
                elif(trend_context == "Trend 0"):
                    trend_position_multiplier = 0.8
                else:
                    trend_position_multiplier = 1.0
            ...
            if (pattern == "Variant Fakeout Daily TPF" or pattern == "Variant Fakeout Trigger TPF"):
            ...
            def get_exit_title(risk_multiplier,pattern_s,trend_pos,trend_percentage):
                exit_title = ""
                if(risk_multiplier == "1_BNR"):
            ...
            if (risk_multiplier == "1_BNR"):
                if (trend_context == "Trend 1+"):
                    if (selected_pair == "XAUUSD"):
                        ...
                        exit_title = get_exit_title(risk_multiplier, pattern, cross_fib,trend_position)
    ...
    def save_workflow_to_sheets(data):
        ...
        try:
            ...
            required_columns = ['selected_pair', 'risk_multiplier', 'position_size', 'stop_pips',
                                'entry_price', 'exit_price', 'target_price', 'status', 'timestamp',
                                'stop_loss_pct', 'max_adverse_excursion', "pattern",
                                "Zone_Position"]  # ADDED NEW FIELDS
            for col in required_columns:
                if col not in data_to_save.columns:
                    data_to_save[col] = None
            ...
            for record_index, record in stage_records:
                ...
                with st.expander(f"Record {record_index + 1}: {record['selected_pair']} - {record['timestamp']}",
                    ...
                    # ORDER READY STAGE ACTIONS
                        ...
                        col_spec, col_move, col_delete = st.columns(3)  # Changed to 4 columns
                    ...
                    # ORDER PLACED STAGE ACTIONS
                        ...
                        col_back, col_move, col_delete = st.columns(3)
                    ...
                    # ORDER FILLED STAGE ACTIONS
                        ...
                        with col14:
                            ...
                            st.text_input(
                                "BE_Price",
                                value=BE_Price,
                                key=f"BE_Price{unique_key_base}",
                                disabled=True
                            )
                        ...
                        with col3:
                            ...
                            if symbol not in st.session_state.first_trail_prices:
                                st.session_state.first_trail_prices[symbol] = calculate_first_trail_price(
                                    original_open_price, st.session_state.original_sl_prices[symbol], direction,
                                    strategy
                                )
