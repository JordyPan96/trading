...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        shapes = ["On OMSS (With TPF)", "Zone/On OB (With TPF)", "Zone/On Left TPF + Left Wick", "Zone/On Right Impulse Candle Wick",
                  "Zone/On Left TPF + Left TPF", "Zone/On Left TPF + OMSS", "Zone/On Left TPF",
                  "Variant 2 Daily TPF", "Variant Fakeout Any TF TPF", "4H BE Scale-in", "No Pattern"]
        ...
        incompatible_map_17 = {
            ...
            '1_BNR_TPF': ["On OMSS (With TPF)", "Zone/On OB (With TPF)", "Zone/On Left TPF + Left Wick", "Zone/On Right Impulse Candle Wick",
            ...
            '2_BNR_TPF': ["On OMSS (With TPF)", "Zone/On OB (With TPF)", "Zone/On Left TPF + Left Wick", "Zone/On Right Impulse Candle Wick",
                         ]
        }
        ...
        with col2:
            ...
            def getPairEntrySL(pair):
                # target_in = 0
                if (pair == "GBPUSD"):
                    base_entry = "18-25 Pip/% in Length"
                    base_sl = 15
