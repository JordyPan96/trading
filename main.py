        ...
        with st.expander(" Add New Record", expanded=False):
            ...
            with col4:
                ...
                pattern_options = ["On Mid OMSS", "On/Zone Mid OB", "On Left TPF + Wick", "Zone/On Right Impulse Candle Wick",
                  ...
                  "Variant Daily TPF", "Variant Fakeout Daily TPF", "No Pattern"]
    ...
    if st.session_state.uploaded_data is not None:
        ...
        incompatible_map_17 = {
            '1_BNR': ["Zone Left TPF + Left TPF", "Zone Left TPF + OMSS", "Zone/On Left TPF",
                      "Variant Daily TPF", "Variant Fakeout Daily TPF","4H BE Scale-in","On Mid OMSS"],
            '1_BNR_TPF': ["On/Zone Mid OB", "On Left TPF + Wick", "Zone/On Right Impulse Candle Wick",
                          "4H BE Scale-in", "Variant Daily TPF", "Variant Fakeout Daily TPF"],
            '2_BNR': ["Zone Left TPF + Left TPF", "Zone Left TPF + OMSS", "Zone/On Left TPF", 
                      "Variant Daily TPF", "Variant Fakeout Daily TPF","On Mid OMSS"],
            ...
            '3_BNR_TPF': ["On/Zone Mid OB", "On Left TPF + Wick", "Zone/On Right Impulse Candle Wick",
                         "Variant Daily TPF", "Variant Fakeout Daily TPF"],
        }
        ...
        incompatible_map_19 = {
            ...
            "22_BNR_TPF": ["Variant Daily TPF", "Variant Fakeout Daily TPF"]
        }
        ...
        incompatible_map_26 = {
            "Wave 1": [],
            "Wave 2+": ['Variant Fakeout Daily TPF'],
        ...
        incompatible_map_30 = {
            "3%-4.99%": ["Variant Fakeout Daily TPF"],
            "5%-6.99%": ["Variant Fakeout Daily TPF"],
            "7%-8.99%": ["Variant Fakeout Daily TPF"],
            "9%-10.99%": ["Variant Fakeout Daily TPF"],
            "11%-12.99% (4% PB)": ["Variant Fakeout Daily TPF"],
            ">=13% (5% PB, ACAD 4%)" :[]
        }
        ...
        with col1:
            ...
            pattern = st.selectbox("Pattern Trigger (Swtich to trigger timeframe, with 3 Candles within 559, then find Left/Right BOS. or left Anchor)",
        ...
        with col2:
            ...
            if (pattern == "Variant Fakeout Daily TPF"):
