...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        incompatible_map_23 = {
            "XAUUSD2_BNR50": [">=99%", ">=119%", ">=149%", ">=2%","NA"],
            "XAUUSD2_BNR559 - 66": [">=99%", ">=119%", ">=149%", ">=2%","NA"],
            "XAUUSD2_BNR66 - 786": [">=99%", ">=149%", ">=179%", ">=2%"],
            "XAUUSD2_BNR786 - 91": [">=99%", ">=149%", ">=179%", ">=2%"],

            "XAUUSD2_BNR_TPF50": [">=99%", ">=119%", ">=149%", "NA"],
            "XAUUSD2_BNR_TPF559 - 66": [">=99%", ">=119%", ">=149%", "NA"],
            ...
            "GBPUSD2_BNR50": [">=99%", ">=119%", ">=179%", ">=2%"],
            "GBPUSD2_BNR559 - 66": [">=99%", ">=119%", ">=179%", ">=2%"],
            "GBPUSD2_BNR66 - 786": [">=119%", ">=149%", ">=179%", ">=2%"],
            "GBPUSD2_BNR786 - 91": [">=119%", ">=149%", ">=179%", ">=2%"],

            "GBPUSD2_BNR_TPF50": [">=99%", ">=119%", ">=179%"],
            "GBPUSD2_BNR_TPF559 - 66": [">=99%", ">=119%", ">=179%"],
            "GBPUSD2_BNR_TPF66 - 786": [">=119%", ">=149%", ">=179%"],
            "GBPUSD2_BNR_TPF786 - 91": [">=119%", ">=149%", ">=179%"],

            "EURUSD2_BNR50": [">=99%", ">=119%", ">=179%", ">=2%"],
            "EURUSD2_BNR559 - 66": [">=99%", ">=119%", ">=179%", ">=2%"],
            "EURUSD2_BNR66 - 786": [">=119%", ">=149%", ">=179%", ">=2%"],
            "EU6rUSD2_BNR786 - 91": [">=119%", ">=149%", ">=179%", ">=2%"],

            "EURUSD2_BNR_TPF50": [">=99%", ">=119%", ">=179%"],
            "EURUSD2_BNR_TPF559 - 66": [">=99%", ">=119%", ">=179%"],
