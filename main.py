...
if st.session_state.current_page == "Home":
    ...
    if st.session_state.uploaded_data is not None:
        ...
        with st.expander(" Add New Record", expanded=False):
            ...
            with col4:
                ...
                pattern_options = ["8H/4H_OB/SR","8H/4H_OB to OB", "8H/4H_OB to TPF","8H/4H_TPF to Fib", "8H/4H TPF Left Leg",
    ...
    if st.session_state.uploaded_data is not None:
        ...
        shapes = ["8H/4H_OB/SR","8H/4H_OB to TPF","8H/4H_OB to OB","8H/4H_TPF to Fib", "8H/4H TPF Left Leg",
                  "Weekly TPF Left Leg",
        ...
        incompatible_map_17 = {
            ...
            '2_BNR_TPF': ["8H/4H_OB to OB",  "8H/4H_OB to TPF",
                          "8H/4H_TPF to Fib","8H/4H_OB/SR","Weekly TPF Left Leg","2 Daily TPF Left Leg", "Daily TPF Left Leg"]
        }
